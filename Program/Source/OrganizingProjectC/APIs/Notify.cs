...
namespace ModBuilder.APIs
{
    class Notify
    {
        ...
        public DialogResult information(string message, MessageBoxButtons buttontype = MessageBoxButtons.OK)
        {
        ...
        public DialogResult question(string message, MessageBoxButtons buttontype = MessageBoxButtons.OK)
        {
        ...
        public DialogResult error(string message, MessageBoxButtons buttontype = MessageBoxButtons.OK)
        {
        ...
        public DialogResult warning(string message, MessageBoxButtons buttontype = MessageBoxButtons.OK)
        {
